...
class UI_Logic_Window(QtWidgets.QMainWindow):
    ...
    def model_init(self):
        ...
        parser.add_argument('--source', type=str, default='photo', help='source')  # file/folder, 0 for webcam
    ...
    def button_image_open(self):
        ...
        name_list = []
        try:
            img_name, _ = QtWidgets.QFileDialog.getOpenFileName(self, "打开图片", "photo/", "*.jpg;;*.png;;All Files(*)")
